pro cor_try,date=date,sat=sat,instr=instr

;;To draw STEREO  picture
;;example:
;;        cor_try,date='120704',sat='STA',instr='COR2'
;; 	 cor_try,date='120704',sat='STA',instr='hi_1'
	...
	;tv, congrid(bytscl(data,0,320),512,512)
