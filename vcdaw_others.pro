pro vcdaw_others,v,vcdaw,lat,lon,ps=ps,png=png,bpath=bpath
    ...
    vcdawp=barplot(binvals,prohist,xtickformat='(A6)',xrange=[0.5,2.8],ytitle='No(#)',POSITION=[0.1,0.86,0.97,0.99],/histogram)
    ...
    text1=text(0.8,0.8,'(b)',/normal,alignment=0.5,font_size=20)
    text2=text(0.8,0.55,'(c)',/normal,alignment=0.5,font_size=20)
    text3=text(0.8,0.28,'(d)',/normal,alignment=0.5,font_size=20)
    ...
    vcdawp1=plot(lat(loc3),vcdaw(loc3),/curr,xtitle='$\theta (!Eo!N)$',xrange=[-40,50],ytitle='V!ICDAW!N(km.s!E-1!N)',position=[0.14,0.12,0.97,0.99],font_size=20)
    vcdawp1.SYMBOL='o'
    ...
    vcdawp2=plot(lon(loc3),vcdaw(loc3),/curr,xtitle='$\phi (!Eo!N)$',xrange=[-120,90],ySHOWTEXT=0,position=[0.01,0.12,0.97,0.99],font_size=20)
    vcdawp2.SYMBOL='o'
